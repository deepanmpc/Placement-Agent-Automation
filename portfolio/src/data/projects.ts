...
export const PROJECTS_DATA: Project[] = [
  {
    id: 'lar1a',
    displayId: '001',
    title: 'Anaavi_Neurodott_Neurodott',
...
export const SKILLS: Skill[] = [
  ...
  { id: '3', name: 'FastAPI', detail: 'Built backend services for RAG pipelines and real-time AI APIs. Learned async design and building low-latency, production-ready endpoints.', projects: ['Anaavi_Neurodott', 'Search Wizard'] },
  ...
  { id: '6', name: 'RAG Systems', detail: 'Built ResumeAnalyse and Anaavi_Neurodott memory systems using retrieval pipelines. Learned how to combine LLMs with vector search for contextual responses.', projects: ['ResumeAnalyse', 'Anaavi_Neurodott'] },
  ...
  { id: '8', name: 'Vector Databases', detail: 'Stored embeddings for semantic search and AI retrieval systems. Learned efficient data structuring for high-accuracy retrieval.', projects: ['ResumeAnalyse', 'Anaavi_Neurodott'] },
  { id: '9', name: 'Docker', detail: 'Containerized AI services and microservices for deployment. Learned environment consistency and scalable service orchestration.', projects: ['Anaavi_Neurodott'] },
  { id: '10', name: 'Microservices Architecture', detail: 'Designed modular backend systems for LaRa AI platform. Learned decoupling, communication patterns, and system scalability.', projects: ['Anaavi_Neurodott'] },
  ...
  { id: '12', name: 'Node.js', detail: 'Handled backend utilities and integration logic across systems. Learned event-driven architecture and API handling.', projects: ['Anaavi_Neurodott', 'Search Wizard'] },
  ...
  { id: '15', name: 'LLM Integration', detail: 'Integrated LLMs into RAG pipelines and chatbot systems. Learned prompt control, response shaping, and system-level integration.', projects: ['ResumeAnalyse', 'AI Therapy System', 'Anaavi_Neurodott'] }
];
