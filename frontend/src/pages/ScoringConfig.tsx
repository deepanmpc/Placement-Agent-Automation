...
const DEFAULT_PLATFORM_FORMULAS = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'Total Repository Stars', weight: 'Max 3 pts', formula: 'MIN(TotalStars / 100, 1) × 3' },
  ...
  const dynamicPlatformFormulas = dbConfig ? [
    ...
    },
    {
      ...
      components: [
        ...
        { name: 'Total Repository Stars', weight: `Max ${dbConfig.github.stars_weight || 3} pts`, formula: `MIN(TotalStars / ${dbConfig.github.stars_divisor || 100}, 1) × ${dbConfig.github.stars_weight || 3}` },
