...
@Entity
@Table(name = "codeforces_snapshots", indexes = {
        @Index(name = "idx_codeforces_student_id", columnList = "student_id"),
        @Index(name = "idx_codeforces_snapshot_date", columnList = "snapshot_date")
},
        uniqueConstraints = @UniqueConstraint(
                name = "uk_codeforces_student_date",
